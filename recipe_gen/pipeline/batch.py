...
from pipeline import DataFrameDataset
from language import PAD_INDEX, pretty_decode, pretty_decode_tokens, N_TECHNIQUES, PAD_TECHNIQUE_INDEX
...
def pad_recipe_info(df_r, max_name_tokens=15, min_ingredients=3, max_ingredients=20,
    ...
    # Pad name
    df_r['name_tokens'] = df_r['name_tokens'].apply(ast.literal_eval)
    ...
    # Pad steps
    df_r['steps_tokens'] = df_r['steps_tokens'].apply(ast.literal_eval)
    ...
    # Clip ingredients
    df_r['ingredient_tokens'] = df_r['ingredient_tokens'].apply(ast.literal_eval)
    ...
    df_r['techniques'] = df_r['techniques'].apply(ast.literal_eval)
