...
import sys
#sys.path.append("<recipe_gen file path>")
sys.path.append("/Users/betty/Downloads/recipe-personalization-master/recipe_gen")

from language import START_INDEX, PAD_INDEX
from pipeline.train import train_model
from pipeline.batch import get_batch_information_general
from pipeline.eval import top_k_logits, sample_next_token
...
if __name__ == "__main__":
    ...
    from pipeline import DataFrameDataset, BatchSampler
    from pipeline.batch import load_full_data, pad_recipe_info, load_recipe_tensors
    ...
    if ingr_emb:
        ...
        df_r['ingredient_ids'] = df_r['ingredient_ids'].apply(ast.literal_eval)
